import { AfterContentChecked, AfterContentInit, ChangeDetectionStrategy, Component, OnDestroy, ViewEncapsulation } from '@angular/core';

@Component({
  selector: 'splitter-secondary',
  // exportAs: 'matDrawer',
  template: '<ng-content></ng-content>',
  styleUrls: ['secondary-pane.component.scss'],
...
export class SecondaryPaneComponent implements AfterContentInit, AfterContentChecked, OnDestroy {
